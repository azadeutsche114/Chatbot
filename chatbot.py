...
#Every answer should be appended with SOS AND EOS token to them
...
#Cameron has value of 0 so inorder to avoid confusion of padding which is also zero we assign other value ot cameron
...
# Removing more than 13 and adding zero's to less than 13
...
# Converting the variables to binary array 0 or 1
...
# 13 dimensions of inputing the sample data into model
enc_inp      = Input(shape = (13,))
dec_inp      = Input(shape = (13,))


# Embedding layer reduces dimensionality like output_dim, LSTM expects 3D data
VOCAB_SIZE   = len(vocab)


#Since we are adding an extra layer of pad so +1
